---
{"dg-publish":true,"permalink":"/homebrew-mechanics/class-and-subclasses/riven/riven-v1/","tags":["character-creation","riven","class","untested"]}
---
...
| Core Riven Traits              |                                                                                            |
| ------------------------------ | ------------------------------------------------------------------------------------------ |
| **Primary Ability**            | Intelligence and Dexterity                                                                 |
| **Hit Point Die**              | D8 per Riven level                                                                         |
...
You have learned to cast spells through your connection to the astral sea and outer planes. See Chapter 7 for the rules on Spellcasting. The Information below details how you use those rules with Paladin spells, which appear in the [[Homebrew Mechanics/Class & Subclasses/Riven/Riven Spell List v1\|Riven Spell List]] later in the class's description.
...
**Prepared Spells of Level 1+.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 Riven spells [[Pot/Character Creation/Spells/Void Blade\|Void Blade]] and [[Pot/Character Creation/Spells/Gravity Shift\|Gravity Shift]] are recommended.
...
| Name                                                    |
| ------------------------------------------------------- |
| [[Homebrew Mechanics/Class & Subclasses/Riven/Void Riven v1\|Tether of the Empty Sea]] (Unfinished) |
| [[Homebrew Mechanics/Class & Subclasses/Riven/Elemental Riven v1\|Tether of the Inner Planes]]      |
| [[Homebrew Mechanics/Class & Subclasses/Riven/TP Riven v1\|Tether of the Traveler]]                 |

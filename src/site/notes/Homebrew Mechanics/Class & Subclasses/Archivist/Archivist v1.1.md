---
{"dg-publish":true,"permalink":"/homebrew-mechanics/class-and-subclasses/archivist/archivist-v1-1/","tags":["class","character-creation","untested","archivist"]}
---
...
As an archiver of the rarest magical objects, you can access the power within them and unleash their magic through spells. The information below details how you use those rules with Archivist spells, which appear in the [[Homebrew Mechanics/Class & Subclasses/Archivist/Archivist Spell List v1\|Archivist Spell List]] later in the class's description
...
**Prepared Spells of Level 1+.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose four level 1 Archivist spells. [[Pot/Character Creation/Spells/Arcane Burst\|Arcane Burst]], [[Pot/Character Creation/Spells/Ward\|Ward]], [Mage Armor](https://dnd5e.wikidot.com/spell:mage-armor), and [Alarm](https://dnd5e.wikidot.com/spell:alarm) are recommended.
...
**Spellcasting Ability.** Intelligence is your spellcasting ability for your Archivist spells.
...
- [[Homebrew Mechanics/Class & Subclasses/Archivist/Coin Archivist\|Favor of the Goldbinder]]
- [[Homebrew Mechanics/Class & Subclasses/Archivist/Seed Archivist\|Favor of the Botanist]]
- [[Homebrew Mechanics/Class & Subclasses/Archivist/Gem Archivist\|Favor of the Gemkeeper]]
